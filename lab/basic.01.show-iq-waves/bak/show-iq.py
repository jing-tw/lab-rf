...
def show_iq_two_channels(filename_prefix, shift, length):
    ...
    stop = shift + length
    drawSignal(time[shift:stop], data_1[shift:stop], ax[0], 'I (Real)', title_1)
    drawSignal(time[shift:stop], data_2[shift:stop], ax[1], 'I (Real)', title_2)
...
def drawSignal(time, data, ax, label, title):
...
# python show-iq.py "D:\work\project\20.06.4-CUAS-Passive radar phase I\receiver\data\20250225\iq_f2.4_bw20m_g0_d3m_S45"
